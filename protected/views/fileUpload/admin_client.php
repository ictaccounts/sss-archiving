...
<div class="slim-mainpanel">
	<div class="container">
		...
		<table style="table-layout: fixed;width: 100%; height:100px">
			<?php
			$counter = 0;
			$datas = FileUpload::model()->search_client($_GET);

			foreach ($datas->getData() as $val) {
				if ($counter % 5 == 0) {
					echo '<tr>';
				}
			?>
				<td style="overflow:hidden !important;height:30px !important">

					<div class="card" style="width: 100% !important; height: 100% !important">
						<div style="overflow:hidden !important;height: 40% !important">
							<?php if (Thumbnail::model()->get_exist($val['id']) == "") { ?>

								<?php if ($val['filecategory'] == 1) { ?>
									<img src="images/file.png" width="100" align="center" style=" display: block;
										margin-left: auto;
										margin-right: auto;
										width: 30%;" />
								<?php } ?>
								<?php if ($val['filecategory'] == 2) { ?>
									<img src="images/image.png" width="100" style=" display: block;
										margin-left: auto;
										margin-right: auto;
										width: 30%;" />
								<?php } ?>
								<?php if ($val['filecategory'] == 3) { ?>
									<img src="images/video.png" width="100" style=" display: block;
										margin-left: auto;
										margin-right: auto;
										width: 30%;" />
								<?php } ?>
								<?php if ($val['filecategory'] == 4) { ?>
									<img src="images/sound.png" width="100" style=" display: block;
										margin-left: auto;
										margin-right: auto;
										width: 30%;" />
								<?php }
							} else { ?>
								<img src="<?php echo Thumbnail::model()->get_thumbnail($val['id']) ?>" width="300" style="padding:10px !important;display: block;margin-left: auto;
						...
						<div class="card-body" style="height: 50% !important">
							<span class="card-text" style="font-size: 16px; display: inline-block;
								...
								<strong><?php echo $val['company']; ?></strong></span>
							<br>
							<span class="card-text" style="font-size: 14px;
								...
								overflow: hidden !important;
								text-overflow: ellipsis;">
								<strong><?php echo $val['title']; ?></strong></span>
							<br>
							<span class="card-text">Date : <strong><?php echo $val['date_transaction']; ?></strong></span>
							<br>
							<span class="card-text">Project Size : <strong><?php echo $val['filesize']; ?></strong></span>
							<br>
							<div class="row">
								...
								<div class="col-lg-6">
									<a href="" onclick='return insertlog(<?php echo $val['id']; ?>,1)' class="btn btn-primary btn-block btn-sm mg-b-10 btn-oblong" data-toggle="modal" data-target="#modaldemo<?php echo $val['id']; ?>"><i class="icon ion-eye"></i> View File</a>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row mg-t-60">
			...
			<div class="col-lg-2">
				<span class="btn btn-primary btn-block btn-sm mg-b-10 btn-oblong" href="" onclick="return seeless(5)">
					<i class="fa fa-minus mg-r-5"></i>See Less</span>
			</div>
			<div class="col-lg-2">
				<span class="btn btn-primary btn-block btn-sm mg-b-10 btn-oblong" href="" onclick="return seemore(5)">
